...
public class UnitTests_TestData_Provider {
	...
	@DataProvider(name = "tc029_searchProductsByRawQuery")
	public static String[][] tc029_searchProductsByWebId(){
		
		ExcelManager excel = null;
		excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator + "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC029_SearchProductsByRawQuery.xlsx");
		return excel.getExcelSheetData("Sheet1");
